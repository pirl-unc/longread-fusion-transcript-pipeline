...
/home/vantwisk/minimap2-2.21_x64-linux/minimap2 ${DATADIR}/fusions-${1}-${5}-${6}-${4}.fq.gz ${DATADIR}/fusions-${1}-${5}-${6}-${4}.fq.gz -X -t ${THREADS} -2 -c -o ${DATADIR_MINIMAP}/fusions-${1}-${5}-${6}-${4}-selfalign.paf
